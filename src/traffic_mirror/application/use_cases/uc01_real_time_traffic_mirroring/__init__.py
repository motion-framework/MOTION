...
USE_CASE = UseCaseDescriptor(
    ...
    evidence=(
        "traffic_mirror.domain.devices defines timestamped device count and speed readings and maps device IDs to coordinates.",
        "traffic_mirror.infrastructure.here acquires and parses flow, jam, incident, closure, confidence, and segment geometry data.",
        "The UC-01 service projects geographic data, derives vehicle populations, and drives the explicit CARLA simulator port.",
        "The installed traffic-mirror CLI exposes map provisioning and real-time mirroring.",
    ),
    dependencies=(
