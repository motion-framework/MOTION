...
USE_CASE = UseCaseDescriptor(
    ...
    evidence=(
        ...
        "traffic_mirror.prediction preserves a legacy per-vehicle incident-risk classifier from speed, controls, and rain; it does not implement the UC-04 traffic forecast semantics.",
